...
- P.S. Viewing the dashboard requires PowerBI professional account.
    - If the viewer doesn't have one, kindly use the [pdf link](./projects/files/sales_insights_report.pdf) to view overall analytical dashboard

```{python}
#| echo: false
%%html
<iframe title="sales_insight_pbi" width="800" height="656"  src="https://app.powerbi.com/reportEmbed?reportId=43d06eb5-ec4b-4b42-98c9-923f1574632b&autoAuth=true&ctid=3531ade6-1052-4651-9242-3199d6164d67" frameborder="0" allowFullScreen="true"></iframe>
```
